...
四场下来，最有效的不是"写更多的规则"，而是**给 Agent 一个审查角色**。

第一战里 Agent B 全程 0 次打开 specmate——不是工具不好，是它根本不知道自己有 mate。第二战给 Agent 加了 Supervisor 审查角色："你要检查代码质量。" 突然开窍了——10+ 次主动调用。第四战更进一步——不是话越多越好，silicon 社恐模式拿了最高分。
